...
public class ConnectedToRailwayDeviceEvent {
    ...
    public ConnectedToRailwayDeviceEvent(boolean connected, TurnoutController turnoutController, RouteController routeController, LocomotiveController locomotiveController, PowerController powerController, PowerSupply powerSupply) {
        this.connected = connected;
